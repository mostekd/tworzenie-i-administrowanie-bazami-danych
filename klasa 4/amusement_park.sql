...
--
-- Host: localhost
-- Generation Time: Dec 05, 2024 at 02:02 PM
...
CREATE TABLE IF NOT EXISTS `attractions` (
  ...
  `permissible_age` int(11) DEFAULT NULL,
...
INSERT INTO `attractions` (`attraction_id`, `name`, `description`, `permissible_age`, `employee_id`) VALUES
(1, 'Rollercoaster', 'Największy rollercoaster w parku', 12, 1),
(2, 'Karuzela', 'Tradycyjna karuzela dla dzieci', 3, 2),
(3, 'Dom strachów', 'Atrakcja dla miłośników horrorów', 15, 3),
(4, 'Basen z kulkami', 'Bezpieczna zabawa dla najmłodszych', 3, 4),
(5, 'Wieża spadków', 'Przygoda dla fanów adrenaliny', 12, 5),
(6, 'Labirynt luster', 'Ciekawe doświadczenie optyczne', 6, 6),
(7, 'Wodny zjazd', 'Atrakcja z efektami wodnymi', 7, 7),
(8, 'Strzelnica', 'Sprawdź swoje umiejętności strzeleckie', 14, 8),
(9, 'Trampoliny', 'Zabawa z wysokościami', 6, 9),
(10, 'Kolejka widokowa', 'Widok na cały park', 2, 10);
...
CREATE TABLE IF NOT EXISTS `repairs` (
  ...
  `end_repair_date` date DEFAULT NULL,
  PRIMARY KEY (`repair_id`),
  KEY `attraction_id` (`attraction_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- RELATIONSHIPS FOR TABLE `repairs`:
--   `attraction_id`
...
INSERT INTO `repairs` (`repair_id`, `attraction_id`, `end_repair_date`) VALUES
(1, 1, '2022-01-02'),
(2, 2, '2022-02-12'),
(3, 3, '2022-03-18'),
(4, 4, '2022-04-28'),
...
INSERT INTO `tickets` (`ticket_id`, `ticket_type_id`, `valid_from`, `valid_to`, `price`) VALUES
(1, 1, '2024-11-01 00:00:00', '2024-11-07 23:59:59', 55.00),
(2, 2, '2024-11-02 00:00:00', '2024-11-07 23:59:59', 32.00),
(3, 3, '2024-11-03 00:00:00', '2024-11-07 23:59:59', 105.00),
(4, 4, '2024-11-04 00:00:00', '2024-11-07 23:59:59', 42.00),
(5, 5, '2024-11-05 00:00:00', '2024-11-07 23:59:59', 210.00),
(6, 6, '2024-11-06 00:00:00', '2024-11-07 23:59:59', 520.00),
(7, 7, '2024-11-07 00:00:00', '2024-11-07 23:59:59', 360.00),
(8, 8, '2024-11-08 00:00:00', '2024-11-14 23:59:59', 85.00),
(9, 9, '2024-11-09 00:00:00', '2024-11-14 23:59:59', 125.00),
(10, 10, '2024-11-10 00:00:00', '2024-11-14 23:59:59', 410.00);
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`approving_employee_id`) REFERENCES `employees` (`employee_id`),
  ADD CONSTRAINT `orders_ibfk_3` FOREIGN KEY (`payment_type_id`) REFERENCES `payment_types` (`payment_type_id`),
  ADD CONSTRAINT `orders_ibfk_4` FOREIGN KEY (`discount_id`) REFERENCES `discounts` (`discount_type_id`);
...
--
ALTER TABLE `repairs`
  ADD CONSTRAINT `repairs_ibfk_1` FOREIGN KEY (`attraction_id`) REFERENCES `attractions` (`attraction_id`);
